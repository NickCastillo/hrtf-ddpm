...
5-Fold CV:
  - ALL_SUBJECTS (93 valid subjects) are split into n_folds roughly equal folds by
    build_nfold_splits() (default n_folds=10; was build_5fold_splits with n_folds=5).
  - build_5fold_splits is retained as a backward-compatible alias.
...
def build_nfold_splits(subjects=None, n_folds=10, seed=42):
    """
...
# Backward-compatible alias (was build_5fold_splits when n_folds defaulted to 5)
build_5fold_splits = build_nfold_splits
